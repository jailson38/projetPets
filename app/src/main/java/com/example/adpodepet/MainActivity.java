        ...
        entrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ("admin".equals(usuario.getText().toString()) && "1234".equals(senha.getText().toString()))
                {
                    ...
                    Toast falhaAutenticacao = Toast.makeText(MainActivity.this,getResources().getString(R.string.activity_main_falha_autenticacao), Toast.LENGTH_LONG);
